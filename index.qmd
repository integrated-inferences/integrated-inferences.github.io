...
[guide](https://macartan.github.io/assets/pdf/papers/2025_CausalQueries.pdf) to forming, updating, and querying causal models with  `CausalQueries` (Tietz et al, provisionally accepted [JSS](https://www.jstatsoft.org/index))
